...
The first branch is the return \texttt{jr} of the swap function, thus it is always taken. The second branch
if the \texttt{if} condition and does not branch most of the time. The second branch is the mysterious branch,
as it is part of some code that looks like added by the compiler.
